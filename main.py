...
# Clustering
parser.add_argument('--TrainWithClustering', type=bool, default=True)
...
parser.add_argument('--cluster_visualization', type=bool, default=True)
...
def ShowClusterIMG(img_folder_path, img_file_paths, clusterID, cluster_labels, n_images=5, save_img=args.save_img):
  iter=0
...
def data_prep(download, img_folder_path, annotation_folder_path, n_data=args.n_data, method=args.method):
  """
...
def clusterANDvisual(X_encoded, img_file_paths, img_folder_path, n_clusters=args.n_clusters, cluster_visualization=args.cluster_visualization):
